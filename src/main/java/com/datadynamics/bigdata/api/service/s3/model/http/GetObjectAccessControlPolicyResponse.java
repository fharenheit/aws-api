...
@XmlRootElement(name = "GetObjectAccessControlPolicyResponse")
public class GetObjectAccessControlPolicyResponse {

    @XmlElement(name = "GetObjectAccessControlPolicyResponse", required = true)
    protected AccessControlPolicy getObjectAccessControlPolicyResponse;

    /**
     * getObjectAccessControlPolicyResponse 속성의 값을 가져옵니다.
     *
    ...
    /**
     * getObjectAccessControlPolicyResponse 속성의 값을 설정합니다.
     *
